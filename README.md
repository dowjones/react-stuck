# React Stuck [![Build Status](https://secure.travis-ci.org/skiano/react-stuck.png)](http://travis-ci.org/skiano/react-stuck) [![NPM version](https://badge.fury.io/js/react-stuck.svg)](http://badge.fury.io/js/react-stuck)
